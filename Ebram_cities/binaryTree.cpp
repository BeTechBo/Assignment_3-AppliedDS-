...
#include <vector>
#include <fstream>
#include "D:\FALL 2023\applied DS\assignment 3\program\Ebram_cities\BinaryTree.h"
...
// otherwise, returns false.
template <class keyType, class dataType>
dataType binaryTree<keyType, dataType>::search2(NodePointer aRoot,
...
void binaryTree<keyType, dataType>::preorder () const       
{
	...
	s.push(t);
	ofstream o;
	o.open("D:\\FALL 2023\\applied DS\\assignment 3\\program\\Dictionary_of_cities.txt");
